  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      if (cultureDocs && cultureDocs.length > 0) {
        const isComplete = cultureDocs[0].action_plan_30 && 
                          cultureDocs[0].action_plan_60 && 
                          cultureDocs[0].action_plan_90 && 
                          cultureDocs[0].action_plan_120;
    ...
    return (
      <AccordionItem 
        ...
        className={cn(
          ...
          isLocked && "border-slate-600/30 bg-slate-800/20 opacity-60"
        )}
      >
            ...
            <div className="flex-1 text-left">
              ...
              {isComplete && completedAt && (
                <p className="text-sm text-emerald-400">
                  Concluído em {format(completedAt, "dd/MM/yyyy", { locale: ptBR })}
                </p>
              )}
              {isLocked && (
                <p className="text-sm text-slate-500">Complete os módulos anteriores para desbloquear</p>
              )}
            </div>
          ...
          <div className="space-y-4 mt-2">
            {isComplete ? (
              <>
                ...
                {module.reportRoute && (
                  <Button 
                    onClick={() => navigate(module.reportRoute!)} 
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {completedModules < modules.length && (
          <Card className="bg-gradient-to-r from-primary/10 to-purple-500/10 border-primary/30 p-6 mt-8">
